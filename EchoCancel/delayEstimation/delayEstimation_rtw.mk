...
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\delayEstimation.lib
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:\Users\sunda\Documents\MATLAB
ARCH                      = win64
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\delayEstimation.lib
...
INCLUDES_BUILDINFO = $(START_DIR)\codegen\lib\delayEstimation;$(START_DIR);$(MATLAB_ROOT)\extern\include;$(MATLAB_ROOT)\simulink\include;$(MATLAB_ROOT)\rtw\c\src;$(MATLAB_ROOT)\rtw\c\src\ext_mode\common;$(MATLAB_ROOT)\rtw\c\ert
...
DEFINES_STANDARD = -DMODEL=delayEstimation -DHAVESTDIO -DUSE_RTMODEL
...
{$(START_DIR)\codegen\lib\delayEstimation}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\codegen\lib\delayEstimation}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
